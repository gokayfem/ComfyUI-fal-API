# fal Model Catalog — auto-generated
...
1503 live models · 59 compatibility-preserved · newest model 2026-09-21 · refresh with `scripts/build_registry.py`

<details>
<summary><strong>image-to-image</strong> — 396 models</summary>
...
| Bria Increase Resolution: Upscale Images up to 4x Without Losing Detail \| fal | [`bria/increase-resolution`](https://fal.ai/models/bria/increase-resolution) | Bria AI | image |
| Bria Product Dimensions | [`bria/product-dimensions`](https://fal.ai/models/bria/product-dimensions) | Bria AI | image |
| Bria Product Holding (FIBO-Edit-1.5) | [`bria/fibo-edit-1.5/product-holding`](https://fal.ai/models/bria/fibo-edit-1.5/product-holding) | Bria AI | images |
...
| Bria Virtual Try-On (FIBO-Edit-1.5) | [`bria/fibo-edit-1.5/virtual-try-on`](https://fal.ai/models/bria/fibo-edit-1.5/virtual-try-on) | Bria AI | images |
...
| Embed Product | [`bria/embed-product`](https://fal.ai/models/bria/embed-product) | Bria AI | image |
...
| Feynobg Background Remover | [`fal-ai/feynobg`](https://fal.ai/models/fal-ai/feynobg) | feyninc | image |
...
| Fibo Edit 1.5 Image Editing | [`bria/fibo-edit-1.5/edit`](https://fal.ai/models/bria/fibo-edit-1.5/edit) | Bria AI | images |
...
| Genfill | [`bria/genfill/v2`](https://fal.ai/models/bria/genfill/v2) | Bria AI | images |
...
| Google Virtual Try On | [`google/virtual-try-on`](https://fal.ai/models/google/virtual-try-on) | Google | images |
...
| GPT Image 2.5 Flare Edit | [`openai/gpt-image-2.5/flare/edit`](https://fal.ai/models/openai/gpt-image-2.5/flare/edit) | OpenAI | images |
| GPT Image 2.5 Sunburst Edit | [`openai/gpt-image-2.5/sunburst/edit`](https://fal.ai/models/openai/gpt-image-2.5/sunburst/edit) | OpenAI | images |
...
| Grok Imagine Image 2.0 | [`xai/grok-imagine-image/v2.0/edit`](https://fal.ai/models/xai/grok-imagine-image/v2.0/edit) | xAI | images |
...
| Hi3D Image to Relief | [`hitem3d/hi3d/image-to-relief`](https://fal.ai/models/hitem3d/hi3d/image-to-relief) | Hitem3D | json |
...
| Ideogram Object Removal | [`fal-ai/ideogram/object-removal`](https://fal.ai/models/fal-ai/ideogram/object-removal) | Ideogram | image |
...
| Latent Consistency Models (v1.5/XL) | [`fal-ai/fast-lcm-diffusion/image-to-image`](https://fal.ai/models/fal-ai/fast-lcm-diffusion/image-to-image) | Stability AI | images |
| Latent Consistency Models (v1.5/XL) | [`fal-ai/fast-lcm-diffusion/inpainting`](https://fal.ai/models/fal-ai/fast-lcm-diffusion/inpainting) | Stability AI | images |
...
| MAI Image 2.5 Pro (Edit) | [`microsoft/mai-image-2.5-pro/edit`](https://fal.ai/models/microsoft/mai-image-2.5-pro/edit) | Microsoft | images |
...
| Meta Muse Image Edit | [`meta/muse-image/edit`](https://fal.ai/models/meta/muse-image/edit) | Meta | images |
...
| Pixelcut Product Photo | [`pixelcut/product-photo`](https://fal.ai/models/pixelcut/product-photo) | Pixelcut | image |
...
| Qwen Image 3 Image Editing | [`alibaba/qwen-image-3/edit`](https://fal.ai/models/alibaba/qwen-image-3/edit) | Alibaba | images |
...
| Replace Background | [`bria/replace-background`](https://fal.ai/models/bria/replace-background) | Bria AI | images |
...
| Seedream | [`bytedance/seedream/v5/lite/edit`](https://fal.ai/models/bytedance/seedream/v5/lite/edit) | Bytedance | images |
| Seedream 5.0 Pro Image Editing | [`bytedance/seedream/v5/pro/edit`](https://fal.ai/models/bytedance/seedream/v5/pro/edit) | Bytedance | images |
| Seedream 5.0 Pro Layerize | [`bytedance/seedream/v5/pro/layerize`](https://fal.ai/models/bytedance/seedream/v5/pro/layerize) | Bytedance | images |
...
| Topaz Adjust Image | [`topaz/adjust/image`](https://fal.ai/models/topaz/adjust/image) | Topaz Labs | image |
| Topaz Denoise Image | [`topaz/denoise/image`](https://fal.ai/models/topaz/denoise/image) | Topaz Labs | image |
| Topaz Restore Image | [`topaz/restore/image`](https://fal.ai/models/topaz/restore/image) | Topaz Labs | image |
| Topaz Sharpen Image | [`topaz/sharpen/image`](https://fal.ai/models/topaz/sharpen/image) | Topaz Labs | image |
| Topaz Upscale Image Creative | [`topaz/upscale/image/creative`](https://fal.ai/models/topaz/upscale/image/creative) | Topaz Labs | image |
| Topaz Upscale Image Generative | [`topaz/upscale/image/generative`](https://fal.ai/models/topaz/upscale/image/generative) | Topaz Labs | image |
| Topaz Upscale Image Precision | [`topaz/upscale/image/precision`](https://fal.ai/models/topaz/upscale/image/precision) | Topaz Labs | image |
| Topaz Upscale Image Transparent | [`topaz/upscale/image/transparent`](https://fal.ai/models/topaz/upscale/image/transparent) | Topaz Labs | image |
...
<details>
<summary><strong>video-to-video</strong> — 205 models</summary>
...
| Bria Video Eraser | [`bria/bria_video_eraser/erase/keypoints`](https://fal.ai/models/bria/bria_video_eraser/erase/keypoints) | Bria AI | video |
| Bria Video Eraser | [`bria/bria_video_eraser/erase/prompt`](https://fal.ai/models/bria/bria_video_eraser/erase/prompt) | Bria AI | video |
| Bria Video Eraser Erase Mask | [`bria/bria_video_eraser/erase/mask`](https://fal.ai/models/bria/bria_video_eraser/erase/mask) | Bria AI | video |
| Bria's VRMBG 3.0 | [`bria/video/background-removal/v3`](https://fal.ai/models/bria/video/background-removal/v3) | Bria AI | video |
...
| Flux 3 Draft Enhance | [`blackforestlabs/flux-3/draft-enhance`](https://fal.ai/models/blackforestlabs/flux-3/draft-enhance) | Black Forest Labs | video |
| Flux 3 Extend Video | [`blackforestlabs/flux-3/extend-video`](https://fal.ai/models/blackforestlabs/flux-3/extend-video) | Black Forest Labs | video |
| Flux 3 Extend Video Draft | [`blackforestlabs/flux-3/extend-video/draft`](https://fal.ai/models/blackforestlabs/flux-3/extend-video/draft) | Black Forest Labs | video |
| Flux 3 FAST Edit Video | [`blackforestlabs/flux-3/edit-video`](https://fal.ai/models/blackforestlabs/flux-3/edit-video) | Black Forest Labs | video |
| Flux Video Upscale | [`blackforestlabs/flux-video-upscale`](https://fal.ai/models/blackforestlabs/flux-video-upscale) | Black Forest Labs | video |
| Gemini Omni Flash | [`google/gemini-omni-flash/edit`](https://fal.ai/models/google/gemini-omni-flash/edit) | Google | video |
| Gemini Omni Flash 1.1 Edit | [`google/gemini-omni-flash/v1.1/edit`](https://fal.ai/models/google/gemini-omni-flash/v1.1/edit) | Google | video |
...
| Heygen | [`fal-ai/heygen/v3/filler-word-removal`](https://fal.ai/models/fal-ai/heygen/v3/filler-word-removal) | Heygen | video |
...
| ID-V2V | [`fal-ai/id-v2v`](https://fal.ai/models/fal-ai/id-v2v) | Eyeline Labs | video |
| ID-V2V Relight | [`fal-ai/id-v2v/relight`](https://fal.ai/models/fal-ai/id-v2v/relight) | Eyeline Labs | video |
...
| Kling Video 4K Video to Video | [`fal-ai/kling-video/o3/4k/video-to-video/reference`](https://fal.ai/models/fal-ai/kling-video/o3/4k/video-to-video/reference) | Kling | video |
| Kling Video 4K Video to Video Edit | [`fal-ai/kling-video/o3/4k/video-to-video/edit`](https://fal.ai/models/fal-ai/kling-video/o3/4k/video-to-video/edit) | Kling | video |
...
| Ltx 2.3 | [`fal-ai/ltx-2.3/reframe`](https://fal.ai/models/fal-ai/ltx-2.3/reframe) | LTX | video |
| LTX 2.3 22B | [`fal-ai/ltx-2.3-22b/reference-video-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2.3-22b/reference-video-to-video/lora) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/clean-plate`](https://fal.ai/models/fal-ai/ltx-2.3-quality/clean-plate) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/colorization`](https://fal.ai/models/fal-ai/ltx-2.3-quality/colorization) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/cross-eyed`](https://fal.ai/models/fal-ai/ltx-2.3-quality/cross-eyed) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/day-to-night`](https://fal.ai/models/fal-ai/ltx-2.3-quality/day-to-night) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/deblur`](https://fal.ai/models/fal-ai/ltx-2.3-quality/deblur) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/decompression`](https://fal.ai/models/fal-ai/ltx-2.3-quality/decompression) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/extend-video`](https://fal.ai/models/fal-ai/ltx-2.3-quality/extend-video) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/extend-video/lora`](https://fal.ai/models/fal-ai/ltx-2.3-quality/extend-video/lora) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/hdr`](https://fal.ai/models/fal-ai/ltx-2.3-quality/hdr) | LTX | json |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/hdr/lora`](https://fal.ai/models/fal-ai/ltx-2.3-quality/hdr/lora) | LTX | json |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/inpaint`](https://fal.ai/models/fal-ai/ltx-2.3-quality/inpaint) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/inpaint/lora`](https://fal.ai/models/fal-ai/ltx-2.3-quality/inpaint/lora) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/instant-shave`](https://fal.ai/models/fal-ai/ltx-2.3-quality/instant-shave) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/outpaint`](https://fal.ai/models/fal-ai/ltx-2.3-quality/outpaint) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/outpaint/lora`](https://fal.ai/models/fal-ai/ltx-2.3-quality/outpaint/lora) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/reference-video-to-video`](https://fal.ai/models/fal-ai/ltx-2.3-quality/reference-video-to-video) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/reference-video-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2.3-quality/reference-video-to-video/lora) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/render-to-real`](https://fal.ai/models/fal-ai/ltx-2.3-quality/render-to-real) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/water-simulation`](https://fal.ai/models/fal-ai/ltx-2.3-quality/water-simulation) | LTX | video |
| LTX Video 2.3 Pro | [`fal-ai/ltx-2.3/extend-video`](https://fal.ai/models/fal-ai/ltx-2.3/extend-video) | LTX | video |
| LTX Video 2.3 Pro | [`fal-ai/ltx-2.3/retake-video`](https://fal.ai/models/fal-ai/ltx-2.3/retake-video) | LTX | video |
| LTX Video-0.9.5 | [`fal-ai/ltx-video-v095/extend`](https://fal.ai/models/fal-ai/ltx-video-v095/extend) | LTX | video |
| LTX Video-0.9.5 | [`fal-ai/ltx-video-v095/multiconditioning`](https://fal.ai/models/fal-ai/ltx-video-v095/multiconditioning) | LTX | video |
| LTX Video-0.9.7 13B Distilled | [`fal-ai/ltx-video-13b-distilled/extend`](https://fal.ai/models/fal-ai/ltx-video-13b-distilled/extend) | LTX | video |
| LTX Video-0.9.7 13B Distilled | [`fal-ai/ltx-video-13b-distilled/multiconditioning`](https://fal.ai/models/fal-ai/ltx-video-13b-distilled/multiconditioning) | LTX | video |
| LTX-2 19B | [`fal-ai/ltx-2-19b/extend-video`](https://fal.ai/models/fal-ai/ltx-2-19b/extend-video) | LTX | video |
| LTX-2 19B | [`fal-ai/ltx-2-19b/extend-video/lora`](https://fal.ai/models/fal-ai/ltx-2-19b/extend-video/lora) | LTX | video |
| LTX-2 19B | [`fal-ai/ltx-2-19b/video-to-video`](https://fal.ai/models/fal-ai/ltx-2-19b/video-to-video) | LTX | video |
| LTX-2 19B | [`fal-ai/ltx-2-19b/video-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2-19b/video-to-video/lora) | LTX | video |
| LTX-2 19B Distilled | [`fal-ai/ltx-2-19b/distilled/extend-video`](https://fal.ai/models/fal-ai/ltx-2-19b/distilled/extend-video) | LTX | video |
| LTX-2 19B Distilled | [`fal-ai/ltx-2-19b/distilled/extend-video/lora`](https://fal.ai/models/fal-ai/ltx-2-19b/distilled/extend-video/lora) | LTX | video |
| LTX-2 19B Distilled | [`fal-ai/ltx-2-19b/distilled/video-to-video`](https://fal.ai/models/fal-ai/ltx-2-19b/distilled/video-to-video) | LTX | video |
| LTX-2 19B Distilled | [`fal-ai/ltx-2-19b/distilled/video-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2-19b/distilled/video-to-video/lora) | LTX | video |
| LTX-2.3 22B | [`fal-ai/ltx-2.3-22b/extend-video`](https://fal.ai/models/fal-ai/ltx-2.3-22b/extend-video) | LTX | video |
| LTX-2.3 22B | [`fal-ai/ltx-2.3-22b/extend-video/lora`](https://fal.ai/models/fal-ai/ltx-2.3-22b/extend-video/lora) | LTX | video |
| LTX-2.3 22B | [`fal-ai/ltx-2.3-22b/reference-video-to-video`](https://fal.ai/models/fal-ai/ltx-2.3-22b/reference-video-to-video) | LTX | video |
| LTX-2.3 22B | [`fal-ai/ltx-2.3-22b/video-to-video`](https://fal.ai/models/fal-ai/ltx-2.3-22b/video-to-video) | LTX | video |
| LTX-2.3 22B | [`fal-ai/ltx-2.3-22b/video-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2.3-22b/video-to-video/lora) | LTX | video |
| LTX-2.3 22B Distilled | [`fal-ai/ltx-2.3-22b/distilled/reference-video-to-video`](https://fal.ai/models/fal-ai/ltx-2.3-22b/distilled/reference-video-to-video) | LTX | video |
| LTX-2.3 22B Distilled | [`fal-ai/ltx-2.3-22b/distilled/reference-video-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2.3-22b/distilled/reference-video-to-video/lora) | LTX | video |
| LTX-2.3 22B Distilled | [`fal-ai/ltx-2.3-22b/distilled/video-to-video`](https://fal.ai/models/fal-ai/ltx-2.3-22b/distilled/video-to-video) | LTX | video |
| LTX-2.3 22B Distilled | [`fal-ai/ltx-2.3-22b/distilled/video-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2.3-22b/distilled/video-to-video/lora) | LTX | video |
| LTX-Video 13B 0.9.8 Distilled | [`fal-ai/ltxv-13b-098-distilled/extend`](https://fal.ai/models/fal-ai/ltxv-13b-098-distilled/extend) | LTX | video |
| LTX-Video 13B 0.9.8 Distilled | [`fal-ai/ltxv-13b-098-distilled/multiconditioning`](https://fal.ai/models/fal-ai/ltxv-13b-098-distilled/multiconditioning) | LTX | video |
| Lucy 2.1 VTON Realtime | [`decart/lucy2-vton/realtime`](https://fal.ai/models/decart/lucy2-vton/realtime) | Decart | json |
| Lucy 2.5 | [`decart/lucy-2-5/realtime`](https://fal.ai/models/decart/lucy-2-5/realtime) | Decart | json |
...
| MiniMax H3 Reference to Video LoRA | [`minimax/h3/reference-to-video/lora`](https://fal.ai/models/minimax/h3/reference-to-video/lora) | Minimax | video |
...
| Topaz Colorize Video | [`topaz/colorize/video`](https://fal.ai/models/topaz/colorize/video) | Topaz Labs | video |
| Topaz Deblur Video | [`topaz/deblur/video`](https://fal.ai/models/topaz/deblur/video) | Topaz Labs | video |
| Topaz Denoise Video | [`topaz/denoise/video`](https://fal.ai/models/topaz/denoise/video) | Topaz Labs | video |
| Topaz Interpolate Video | [`topaz/interpolate/video`](https://fal.ai/models/topaz/interpolate/video) | Topaz Labs | video |
| Topaz Sdr To Hdr Video | [`topaz/sdr-to-hdr/video`](https://fal.ai/models/topaz/sdr-to-hdr/video) | Topaz Labs | video |
| Topaz Upscale Video Creative | [`topaz/upscale/video/creative`](https://fal.ai/models/topaz/upscale/video/creative) | Topaz Labs | video |
| Topaz Upscale Video Generative | [`topaz/upscale/video/generative`](https://fal.ai/models/topaz/upscale/video/generative) | Topaz Labs | video |
| Topaz Upscale Video Precision | [`topaz/upscale/video/precision`](https://fal.ai/models/topaz/upscale/video/precision) | Topaz Labs | video |
| V1.1 Video to Video Music | [`sonilo/v1.1/video-to-video-music`](https://fal.ai/models/sonilo/v1.1/video-to-video-music) | Sonilo | video |
| V1.1 Video to Video Sound Effects | [`sonilo/v1.1/video-to-video-sound-effects`](https://fal.ai/models/sonilo/v1.1/video-to-video-sound-effects) | Sonilo | video |
| V2.6 | [`wan/v2.6/reference-to-video/flash`](https://fal.ai/models/wan/v2.6/reference-to-video/flash) | Alibaba | video |
| VEED Lipsync | [`veed/lipsync/v2`](https://fal.ai/models/veed/lipsync/v2) | Veed | video |
...
| Video | [`bria/video/background-removal/green-screen-despill`](https://fal.ai/models/bria/video/background-removal/green-screen-despill) | Bria AI | video |
| Video | [`bria/video/erase/keypoints`](https://fal.ai/models/bria/video/erase/keypoints) | Bria AI | video |
| Video | [`bria/video/erase/mask`](https://fal.ai/models/bria/video/erase/mask) | Bria AI | video |
| Video | [`bria/video/erase/prompt`](https://fal.ai/models/bria/video/erase/prompt) | Bria AI | video |
...
| Wan 3.0 Prime | [`alibaba/wan-3.0-prime/reference-to-video`](https://fal.ai/models/alibaba/wan-3.0-prime/reference-to-video) | Alibaba | video |
| Wan Motion | [`fal-ai/wan-motion`](https://fal.ai/models/fal-ai/wan-motion) | Alibaba | video |
...
<details>
<summary><strong>image-to-video</strong> — 202 models</summary>
...
| Flux 3 First Last Frame to Video | [`blackforestlabs/flux-3/first-last-frame-to-video`](https://fal.ai/models/blackforestlabs/flux-3/first-last-frame-to-video) | Black Forest Labs | video |
| Flux 3 First Last Frame to Video Draft | [`blackforestlabs/flux-3/first-last-frame-to-video/draft`](https://fal.ai/models/blackforestlabs/flux-3/first-last-frame-to-video/draft) | Black Forest Labs | video |
| FLUX 3 Image to Video | [`blackforestlabs/flux-3/image-to-video`](https://fal.ai/models/blackforestlabs/flux-3/image-to-video) | Black Forest Labs | video |
| Flux 3 Image to Video | [`blackforestlabs/flux-3/keyframes-to-video`](https://fal.ai/models/blackforestlabs/flux-3/keyframes-to-video) | Black Forest Labs | video |
| Flux 3 Image To Video Draft | [`blackforestlabs/flux-3/image-to-video/draft`](https://fal.ai/models/blackforestlabs/flux-3/image-to-video/draft) | Black Forest Labs | video |
| Flux 3 Keyframes To Video Draft | [`blackforestlabs/flux-3/keyframes-to-video/draft`](https://fal.ai/models/blackforestlabs/flux-3/keyframes-to-video/draft) | Black Forest Labs | video |
...
| Gemini Omni Flash 1.1 Image to Video | [`google/gemini-omni-flash/v1.1/image-to-video`](https://fal.ai/models/google/gemini-omni-flash/v1.1/image-to-video) | Google | video |
| Gemini Omni Flash 1.1 Reference to Video | [`google/gemini-omni-flash/v1.1/reference-to-video`](https://fal.ai/models/google/gemini-omni-flash/v1.1/reference-to-video) | — | video |
...
| Grok Imagine Video 1.5 Reference to Video | [`xai/grok-imagine-video/v1.5/reference-to-video`](https://fal.ai/models/xai/grok-imagine-video/v1.5/reference-to-video) | xAI | video |
| H3 Max Camera Controls | [`minimax/h3-max/camera-controls`](https://fal.ai/models/minimax/h3-max/camera-controls) | Minimax | video |
| H3 Max Image to Video | [`minimax/h3-max/image-to-video`](https://fal.ai/models/minimax/h3-max/image-to-video) | Minimax | video |
| H3 Max Lip Sync Image to Video | [`minimax/h3-max/lip-sync/image-to-video`](https://fal.ai/models/minimax/h3-max/lip-sync/image-to-video) | Minimax | video |
| H3 Max Reference to Video | [`minimax/h3-max/reference-to-video`](https://fal.ai/models/minimax/h3-max/reference-to-video) | Minimax | video |
| H3 Max Turbo Image to Video | [`minimax/h3-max-turbo/image-to-video`](https://fal.ai/models/minimax/h3-max-turbo/image-to-video) | Minimax | video |
...
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/image-to-video`](https://fal.ai/models/fal-ai/ltx-2.3-quality/image-to-video) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/image-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2.3-quality/image-to-video/lora) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/ingredient`](https://fal.ai/models/fal-ai/ltx-2.3-quality/ingredient) | LTX | video |
| LTX 2.3 Video Fast | [`fal-ai/ltx-2.3/image-to-video/fast`](https://fal.ai/models/fal-ai/ltx-2.3/image-to-video/fast) | LTX | video |
| LTX 2.3 Video Pro | [`fal-ai/ltx-2.3/image-to-video`](https://fal.ai/models/fal-ai/ltx-2.3/image-to-video) | LTX | video |
| LTX 2.5 Image to Video Fast | [`lightricks/ltx-2.5/image-to-video/fast`](https://fal.ai/models/lightricks/ltx-2.5/image-to-video/fast) | LTX | video |
| LTX 2.5 Image to Video Pro | [`lightricks/ltx-2.5/image-to-video/pro`](https://fal.ai/models/lightricks/ltx-2.5/image-to-video/pro) | LTX | video |
| LTX Video (preview) | [`fal-ai/ltx-video/image-to-video`](https://fal.ai/models/fal-ai/ltx-video/image-to-video) | LTX | video |
| LTX Video-0.9.7 13B Distilled | [`fal-ai/ltx-video-13b-distilled/image-to-video`](https://fal.ai/models/fal-ai/ltx-video-13b-distilled/image-to-video) | LTX | video |
| LTX-2 19B | [`fal-ai/ltx-2-19b/image-to-video`](https://fal.ai/models/fal-ai/ltx-2-19b/image-to-video) | LTX | video |
| LTX-2 19B | [`fal-ai/ltx-2-19b/image-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2-19b/image-to-video/lora) | LTX | video |
| LTX-2 19B Distilled | [`fal-ai/ltx-2-19b/distilled/image-to-video`](https://fal.ai/models/fal-ai/ltx-2-19b/distilled/image-to-video) | LTX | video |
| LTX-2 19B Distilled | [`fal-ai/ltx-2-19b/distilled/image-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2-19b/distilled/image-to-video/lora) | LTX | video |
| LTX-2.3 22B | [`fal-ai/ltx-2.3-22b/image-to-video`](https://fal.ai/models/fal-ai/ltx-2.3-22b/image-to-video) | LTX | video |
| LTX-2.3 22B | [`fal-ai/ltx-2.3-22b/image-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2.3-22b/image-to-video/lora) | LTX | video |
| LTX-2.3 22B Distilled | [`fal-ai/ltx-2.3-22b/distilled/image-to-video`](https://fal.ai/models/fal-ai/ltx-2.3-22b/distilled/image-to-video) | LTX | video |
| LTX-2.3 22B Distilled | [`fal-ai/ltx-2.3-22b/distilled/image-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2.3-22b/distilled/image-to-video/lora) | LTX | video |
| LTX-Video 13B 0.9.8 Distilled | [`fal-ai/ltxv-13b-098-distilled/image-to-video`](https://fal.ai/models/fal-ai/ltxv-13b-098-distilled/image-to-video) | LTX | video |
...
| MiniMax H3 Image to Video | [`minimax/h3/image-to-video`](https://fal.ai/models/minimax/h3/image-to-video) | Minimax | video |
| MiniMax H3 Image to Video LoRA | [`minimax/h3/image-to-video/lora`](https://fal.ai/models/minimax/h3/image-to-video/lora) | Minimax | video |
| MiniMax H3 Reference to Video | [`minimax/h3/reference-to-video`](https://fal.ai/models/minimax/h3/reference-to-video) | Minimax | video |
...
| Mirage Avatar X | [`mirage-api/avatar-x/reference-to-video`](https://fal.ai/models/mirage-api/avatar-x/reference-to-video) | Mirage | video |
...
| Seedance 2.0 US Image to Video | [`bytedance/seedance-2.0/us/image-to-video`](https://fal.ai/models/bytedance/seedance-2.0/us/image-to-video) | Bytedance | video |
| Seedance 2.0 US Reference to Video | [`bytedance/seedance-2.0/us/reference-to-video`](https://fal.ai/models/bytedance/seedance-2.0/us/reference-to-video) | Bytedance | video |
| Seedance 2.5 Image to Video | [`bytedance/seedance-2.5/image-to-video`](https://fal.ai/models/bytedance/seedance-2.5/image-to-video) | Bytedance | video |
| Seedance 2.5 Reference to Video | [`bytedance/seedance-2.5/reference-to-video`](https://fal.ai/models/bytedance/seedance-2.5/reference-to-video) | Bytedance | video |
| Seedance 2.5 US Image to Video | [`bytedance/seedance-2.5/us/image-to-video`](https://fal.ai/models/bytedance/seedance-2.5/us/image-to-video) | Bytedance | video |
| Seedance 2.5 US Reference to Video | [`bytedance/seedance-2.5/us/reference-to-video`](https://fal.ai/models/bytedance/seedance-2.5/us/reference-to-video) | Bytedance | video |
...
| Veo 3.1 Fast | [`fal-ai/veo3.1/fast/reference-to-video`](https://fal.ai/models/fal-ai/veo3.1/fast/reference-to-video) | Google | video |
...
| Wan 3.0 | [`alibaba/wan-3.0/image-to-video`](https://fal.ai/models/alibaba/wan-3.0/image-to-video) | Alibaba | video |
| Wan 3.0 | [`alibaba/wan-3.0/reference-to-video`](https://fal.ai/models/alibaba/wan-3.0/reference-to-video) | Alibaba | video |
| Wan 3.0 Prime | [`alibaba/wan-3.0-prime/image-to-video`](https://fal.ai/models/alibaba/wan-3.0-prime/image-to-video) | Alibaba | video |
...
<details>
<summary><strong>text-to-image</strong> — 199 models</summary>
...
| Fibo Gen 1.5 Text to Image | [`bria/fibo-gen-1.5/text-to-image`](https://fal.ai/models/bria/fibo-gen-1.5/text-to-image) | Bria AI | images |
...
| GPT Image 2.5 Flare Text to Image | [`openai/gpt-image-2.5/flare/text-to-image`](https://fal.ai/models/openai/gpt-image-2.5/flare/text-to-image) | OpenAI | images |
| GPT Image 2.5 Sunburst Text to Image | [`openai/gpt-image-2.5/sunburst/text-to-image`](https://fal.ai/models/openai/gpt-image-2.5/sunburst/text-to-image) | OpenAI | images |
...
| Grok Imagine Image 2.0 | [`xai/grok-imagine-image/v2.0/text-to-image`](https://fal.ai/models/xai/grok-imagine-image/v2.0/text-to-image) | xAI | images |
...
| Hidream O1 Image | [`fal-ai/hidream-o1-image/dev`](https://fal.ai/models/fal-ai/hidream-o1-image/dev) | Hidream | images |
...
| Krea 2 Text to Image Turbo LoRA | [`fal-ai/krea-2/turbo/lora`](https://fal.ai/models/fal-ai/krea-2/turbo/lora) | Krea | images |
| Krea 2 Text to Image Turbo Style | [`fal-ai/krea-2/turbo/style`](https://fal.ai/models/fal-ai/krea-2/turbo/style) | Krea | images |
| Krea 2 Turbo | [`fal-ai/krea-2/turbo`](https://fal.ai/models/fal-ai/krea-2/turbo) | Krea | images |
| Latent Consistency Models (v1.5/XL) | [`fal-ai/fast-lcm-diffusion`](https://fal.ai/models/fal-ai/fast-lcm-diffusion) | Stability AI | images |
...
| MAI Image 2.5 Pro (Text to Image) | [`microsoft/mai-image-2.5-pro`](https://fal.ai/models/microsoft/mai-image-2.5-pro) | Microsoft | images |
| Mai Image 2.5 Text to Image | [`microsoft/mai-image-2.5`](https://fal.ai/models/microsoft/mai-image-2.5) | Microsoft | images |
| Meta Muse Image Text to Image | [`meta/muse-image/text-to-image`](https://fal.ai/models/meta/muse-image/text-to-image) | Meta | images |
...
| Qwen Image 3 Text to Image | [`alibaba/qwen-image-3/text-to-image`](https://fal.ai/models/alibaba/qwen-image-3/text-to-image) | Alibaba | images |
...
| Recraft V4 Styles Pro Text to Image | [`recraft/v4/style/pro/text-to-image`](https://fal.ai/models/recraft/v4/style/pro/text-to-image) | Recraft | images |
| Recraft V4 Styles Pro Text to Vector | [`recraft/v4/style/pro/text-to-vector`](https://fal.ai/models/recraft/v4/style/pro/text-to-vector) | Recraft | images |
| Recraft V4 Styles Text to Image | [`recraft/v4/style/text-to-image`](https://fal.ai/models/recraft/v4/style/text-to-image) | Recraft | images |
| Recraft V4 Styles Text to Vector | [`recraft/v4/style/text-to-vector`](https://fal.ai/models/recraft/v4/style/text-to-vector) | Recraft | images |
...
| Seedream | [`bytedance/seedream/v5/lite/text-to-image`](https://fal.ai/models/bytedance/seedream/v5/lite/text-to-image) | Bytedance | images |
| Seedream 5.0 Pro Text to Image | [`bytedance/seedream/v5/pro/text-to-image`](https://fal.ai/models/bytedance/seedream/v5/pro/text-to-image) | Bytedance | images |
...
| V4.0q [fast] | [`ideogram/v4/fast`](https://fal.ai/models/ideogram/v4/fast) | Ideogram | images |
| V4.0q [instant] | [`ideogram/v4/instant`](https://fal.ai/models/ideogram/v4/instant) | Ideogram | images |
...
<details>
<summary><strong>text-to-video</strong> — 139 models</summary>
...
| Avatar X | [`mirage-api/avatar-x/text-to-video`](https://fal.ai/models/mirage-api/avatar-x/text-to-video) | Mirage | video |
...
| Boreal | [`creatify/boreal`](https://fal.ai/models/creatify/boreal) | Creatify AI | video |
...
| Flux 3 Text to Video | [`blackforestlabs/flux-3/text-to-video`](https://fal.ai/models/blackforestlabs/flux-3/text-to-video) | Black Forest Labs | video |
| Flux 3 Text To Video Draft | [`blackforestlabs/flux-3/text-to-video/draft`](https://fal.ai/models/blackforestlabs/flux-3/text-to-video/draft) | Black Forest Labs | video |
| Gemini Omni Flash | [`google/gemini-omni-flash`](https://fal.ai/models/google/gemini-omni-flash) | Google | video |
| Gemini Omni Flash 1.1 Text to Video | [`google/gemini-omni-flash/v1.1/text-to-video`](https://fal.ai/models/google/gemini-omni-flash/v1.1/text-to-video) | Google | video |
...
| Grok Imagine Video 1.5 Text to Video | [`xai/grok-imagine-video/v1.5/text-to-video`](https://fal.ai/models/xai/grok-imagine-video/v1.5/text-to-video) | xAI | video |
| H3 Max 16-bit Pixel | [`minimax/h3-max/styles/16bit-pixel`](https://fal.ai/models/minimax/h3-max/styles/16bit-pixel) | Minimax | video |
| H3 Max Hand Drawn | [`minimax/h3-max/styles/hand-drawn`](https://fal.ai/models/minimax/h3-max/styles/hand-drawn) | Minimax | video |
| H3 Max Low Poly | [`minimax/h3-max/styles/low-poly`](https://fal.ai/models/minimax/h3-max/styles/low-poly) | Minimax | video |
| H3 Max Retro Toon 70s | [`minimax/h3-max/styles/retro-toon-70s`](https://fal.ai/models/minimax/h3-max/styles/retro-toon-70s) | Minimax | video |
| H3 Max Turbo Text to Video | [`minimax/h3-max-turbo/text-to-video`](https://fal.ai/models/minimax/h3-max-turbo/text-to-video) | Minimax | video |
| H3 Max VHS | [`minimax/h3-max/styles/vhs`](https://fal.ai/models/minimax/h3-max/styles/vhs) | Minimax | video |
...
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/text-to-video`](https://fal.ai/models/fal-ai/ltx-2.3-quality/text-to-video) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/text-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2.3-quality/text-to-video/lora) | LTX | video |
| LTX 2.3 Video Fast | [`fal-ai/ltx-2.3/text-to-video/fast`](https://fal.ai/models/fal-ai/ltx-2.3/text-to-video/fast) | LTX | video |
| Ltx 2.5 Text to Video Fast | [`lightricks/ltx-2.5/text-to-video/fast`](https://fal.ai/models/lightricks/ltx-2.5/text-to-video/fast) | LTX | video |
| Ltx 2.5 Text to Video Fast | [`lightricks/ltx-2.5/text-to-video/pro`](https://fal.ai/models/lightricks/ltx-2.5/text-to-video/pro) | LTX | video |
| LTX Video (preview) | [`fal-ai/ltx-video`](https://fal.ai/models/fal-ai/ltx-video) | LTX | video |
| LTX Video 2.3 Pro | [`fal-ai/ltx-2.3/text-to-video`](https://fal.ai/models/fal-ai/ltx-2.3/text-to-video) | LTX | video |
| LTX Video-0.9.5 | [`fal-ai/ltx-video-v095`](https://fal.ai/models/fal-ai/ltx-video-v095) | LTX | video |
| LTX Video-0.9.7 13B Distilled | [`fal-ai/ltx-video-13b-distilled`](https://fal.ai/models/fal-ai/ltx-video-13b-distilled) | LTX | video |
| LTX-2 19B | [`fal-ai/ltx-2-19b/text-to-video`](https://fal.ai/models/fal-ai/ltx-2-19b/text-to-video) | LTX | video |
| LTX-2 19B | [`fal-ai/ltx-2-19b/text-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2-19b/text-to-video/lora) | LTX | video |
| LTX-2 19B Distilled | [`fal-ai/ltx-2-19b/distilled/text-to-video`](https://fal.ai/models/fal-ai/ltx-2-19b/distilled/text-to-video) | LTX | video |
| LTX-2 19B Distilled | [`fal-ai/ltx-2-19b/distilled/text-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2-19b/distilled/text-to-video/lora) | LTX | video |
| LTX-2.3 22B | [`fal-ai/ltx-2.3-22b/text-to-video`](https://fal.ai/models/fal-ai/ltx-2.3-22b/text-to-video) | LTX | video |
| LTX-2.3 22B | [`fal-ai/ltx-2.3-22b/text-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2.3-22b/text-to-video/lora) | LTX | video |
| LTX-2.3 22B Distilled | [`fal-ai/ltx-2.3-22b/distilled/text-to-video`](https://fal.ai/models/fal-ai/ltx-2.3-22b/distilled/text-to-video) | LTX | video |
| LTX-2.3 22B Distilled | [`fal-ai/ltx-2.3-22b/distilled/text-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2.3-22b/distilled/text-to-video/lora) | LTX | video |
| LTX-Video 13B 0.9.8 Distilled | [`fal-ai/ltxv-13b-098-distilled`](https://fal.ai/models/fal-ai/ltxv-13b-098-distilled) | LTX | video |
...
| MiniMax H3 Max Text to Video | [`minimax/h3-max/text-to-video`](https://fal.ai/models/minimax/h3-max/text-to-video) | Minimax | video |
| MiniMax H3 Text to Video | [`minimax/h3/text-to-video`](https://fal.ai/models/minimax/h3/text-to-video) | Minimax | video |
| MiniMax H3 Text to Video LoRA | [`minimax/h3/text-to-video/lora`](https://fal.ai/models/minimax/h3/text-to-video/lora) | Minimax | video |
...
| Seedance 2.0 US Text to Video | [`bytedance/seedance-2.0/us/text-to-video`](https://fal.ai/models/bytedance/seedance-2.0/us/text-to-video) | Bytedance | video |
| Seedance 2.5 Text to Video | [`bytedance/seedance-2.5/text-to-video`](https://fal.ai/models/bytedance/seedance-2.5/text-to-video) | Bytedance | video |
| Seedance 2.5 US Text to Video | [`bytedance/seedance-2.5/us/text-to-video`](https://fal.ai/models/bytedance/seedance-2.5/us/text-to-video) | Bytedance | video |
...
| Wan 3.0 Prime | [`alibaba/wan-3.0-prime/text-to-video`](https://fal.ai/models/alibaba/wan-3.0-prime/text-to-video) | Alibaba | video |
| Wan Text to Video | [`alibaba/wan-3.0/text-to-video`](https://fal.ai/models/alibaba/wan-3.0/text-to-video) | Alibaba | video |
...
<details>
<summary><strong>training</strong> — 58 models</summary>
...
| LTX 2.3 Trainer (V2) - Audio Inpainting | [`fal-ai/ltx23-trainer-v2/audio-inpaint`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/audio-inpaint) | LTX | video |
| LTX 2.3 Trainer (V2) - Audio+Video Reference IC-LoRA | [`fal-ai/ltx23-trainer-v2/ic-lora/av2av`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/ic-lora/av2av) | LTX | video |
| LTX 2.3 Trainer (V2) - Audio+Video Reference Transformation | [`fal-ai/ltx23-trainer-v2/av2av`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/av2av) | LTX | video |
| LTX 2.3 Trainer (V2) - Audio-to-Audio | [`fal-ai/ltx23-trainer-v2/a2a`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/a2a) | LTX | video |
| LTX 2.3 Trainer (V2) - Audio-to-Audio IC-LoRA | [`fal-ai/ltx23-trainer-v2/ic-lora/a2a`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/ic-lora/a2a) | LTX | video |
| LTX 2.3 Trainer (V2) - Audio-to-Video | [`fal-ai/ltx23-trainer-v2/a2v`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/a2v) | LTX | video |
| LTX 2.3 Trainer (V2) - Backward Audio Extension | [`fal-ai/ltx23-trainer-v2/audio-extend-suffix`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/audio-extend-suffix) | LTX | video |
| LTX 2.3 Trainer (V2) - Backward Video Extension | [`fal-ai/ltx23-trainer-v2/extend-suffix`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/extend-suffix) | LTX | video |
| LTX 2.3 Trainer (V2) - Forward Audio Extension | [`fal-ai/ltx23-trainer-v2/audio-extend-prefix`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/audio-extend-prefix) | LTX | video |
| LTX 2.3 Trainer (V2) - Forward Video Extension | [`fal-ai/ltx23-trainer-v2/extend-prefix`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/extend-prefix) | LTX | video |
| LTX 2.3 Trainer (V2) - Image-to-Video | [`fal-ai/ltx23-trainer-v2/i2v`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/i2v) | LTX | video |
| LTX 2.3 Trainer (V2) - Keyframe Interpolation | [`fal-ai/ltx23-trainer-v2/interpolate`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/interpolate) | LTX | video |
| LTX 2.3 Trainer (V2) - Masked Audio+Video IC-LoRA | [`fal-ai/ltx23-trainer-v2/ic-lora/av2av-masked`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/ic-lora/av2av-masked) | LTX | video |
| LTX 2.3 Trainer (V2) - Masked Audio+Video Transformation | [`fal-ai/ltx23-trainer-v2/av2av-masked`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/av2av-masked) | LTX | video |
| LTX 2.3 Trainer (V2) - Masked Video-to-Video | [`fal-ai/ltx23-trainer-v2/v2v-masked`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/v2v-masked) | LTX | video |
| LTX 2.3 Trainer (V2) - Masked Video-to-Video IC-LoRA | [`fal-ai/ltx23-trainer-v2/ic-lora/v2v-masked`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/ic-lora/v2v-masked) | LTX | video |
| LTX 2.3 Trainer (V2) - Spatial Outpainting | [`fal-ai/ltx23-trainer-v2/outpaint`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/outpaint) | LTX | video |
| LTX 2.3 Trainer (V2) - Text-to-Audio | [`fal-ai/ltx23-trainer-v2/t2a`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/t2a) | LTX | video |
| LTX 2.3 Trainer (V2) - Text-to-Video | [`fal-ai/ltx23-trainer-v2/t2v`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/t2v) | LTX | video |
| LTX 2.3 Trainer (V2) - Video Inpainting | [`fal-ai/ltx23-trainer-v2/inpaint`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/inpaint) | LTX | video |
| LTX 2.3 Trainer (V2) - Video-to-Audio | [`fal-ai/ltx23-trainer-v2/v2a`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/v2a) | LTX | video |
| LTX 2.3 Trainer (V2) - Video-to-Video | [`fal-ai/ltx23-trainer-v2/v2v`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/v2v) | LTX | video |
| LTX 2.3 Trainer (V2) - Video-to-Video IC-LoRA | [`fal-ai/ltx23-trainer-v2/ic-lora/v2v`](https://fal.ai/models/fal-ai/ltx23-trainer-v2/ic-lora/v2v) | LTX | video |
| LTX-2.3 22B Video to Video Trainer | [`fal-ai/ltx23-v2v-trainer`](https://fal.ai/models/fal-ai/ltx23-v2v-trainer) | LTX | video |
| LTX-2.3 22B Video Trainer | [`fal-ai/ltx23-video-trainer`](https://fal.ai/models/fal-ai/ltx23-video-trainer) | LTX | video |
| MiniMax H3 First Last Frame LoRA Trainer | [`minimax/h3/flf2v/trainer`](https://fal.ai/models/minimax/h3/flf2v/trainer) | Minimax | json |
| MiniMax H3 Image to Video Audio LoRA Trainer | [`minimax/h3/i2v/trainer`](https://fal.ai/models/minimax/h3/i2v/trainer) | Minimax | json |
| MiniMax H3 Reference to Video LoRA Trainer | [`minimax/h3/ref2va/trainer`](https://fal.ai/models/minimax/h3/ref2va/trainer) | Minimax | json |
| MiniMax H3 Text to Video LoRA Trainer | [`minimax/h3/t2v/trainer`](https://fal.ai/models/minimax/h3/t2v/trainer) | Minimax | json |
...
| Recraft V4 Styles Create Style | [`recraft/v4/create-style`](https://fal.ai/models/recraft/v4/create-style) | Recraft | text |
| Recraft V4 Styles Pro Create Style | [`recraft/v4/pro/create-style`](https://fal.ai/models/recraft/v4/pro/create-style) | Recraft | text |
...
<details>
<summary><strong>text-to-audio</strong> — 50 models</summary>
...
| Elevenlabs Music v2 | [`elevenlabs/music/v2`](https://fal.ai/models/elevenlabs/music/v2) | ElevenLabs | audio |
| Elevenlabs Music v2.5 | [`elevenlabs/music/v2.5`](https://fal.ai/models/elevenlabs/music/v2.5) | ElevenLabs | audio |
...
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/text-to-audio`](https://fal.ai/models/fal-ai/ltx-2.3-quality/text-to-audio) | LTX | audio |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/text-to-audio/lora`](https://fal.ai/models/fal-ai/ltx-2.3-quality/text-to-audio/lora) | LTX | audio |
| Lyria 3 Pro | [`fal-ai/lyria3/pro`](https://fal.ai/models/fal-ai/lyria3/pro) | Google | audio |
| Lyria 3.5 | [`google/lyria-3.5`](https://fal.ai/models/google/lyria-3.5) | Google | audio |
...
| MiniMax Music 3 | [`minimax/music-3`](https://fal.ai/models/minimax/music-3) | Minimax | audio |
...
| Stable Audio 3 Small SFX Base Text to Audio | [`fal-ai/stable-audio-3/small/sfx/base/text-to-audio`](https://fal.ai/models/fal-ai/stable-audio-3/small/sfx/base/text-to-audio) | Stability AI | audio |
...
| V1.1 Text to Sound Effects | [`sonilo/v1.1/text-to-sound-effects`](https://fal.ai/models/sonilo/v1.1/text-to-sound-effects) | Sonilo | audio |
| Zonos-Audio-Clone | [`fal-ai/zonos`](https://fal.ai/models/fal-ai/zonos) | — | audio |

</details>

<details>
<summary><strong>image-to-3d</strong> — 44 models</summary>

| Model | Endpoint | Lab | Output |
| --- | --- | --- | --- |
| Hi3D Image to 3D | [`hitem3d/hi3d/image-to-3d`](https://fal.ai/models/hitem3d/hi3d/image-to-3d) | Hitem3D | file |
| Hi3D Image to 3D | [`hitem3d/hi3d/v3.0/image-to-3d`](https://fal.ai/models/hitem3d/hi3d/v3.0/image-to-3d) | Hitem3D | file |
| Hi3D Multiview to 3D | [`hitem3d/hi3d/multi-view-to-3d`](https://fal.ai/models/hitem3d/hi3d/multi-view-to-3d) | Hitem3D | file |
| Hi3D Multiview to 3D | [`hitem3d/hi3d/v3.0/multi-view-to-3d`](https://fal.ai/models/hitem3d/hi3d/v3.0/multi-view-to-3d) | Hitem3D | file |
...
| Meshy 7.1 Image to 3D | [`meshy/v7.1/image-to-3d`](https://fal.ai/models/meshy/v7.1/image-to-3d) | Meshy | file |
| Meshy 7.1 Multi Image to 3D | [`meshy/v7.1/multi-image-to-3d`](https://fal.ai/models/meshy/v7.1/multi-image-to-3d) | Meshy | file |
...
| Tripo P2 Image to 3D | [`tripo3d/p2/image-to-3d`](https://fal.ai/models/tripo3d/p2/image-to-3d) | Tripo3D | file |
...
| V7 Image to 3D | [`meshy/v7/image-to-3d`](https://fal.ai/models/meshy/v7/image-to-3d) | Meshy | file |
| V7 Multi Image to 3D | [`meshy/v7/multi-image-to-3d`](https://fal.ai/models/meshy/v7/multi-image-to-3d) | Meshy | file |
...
<details>
<summary><strong>text-to-speech</strong> — 34 models</summary>
...
| Qwen Audio 3.0 TTS (Flash) | [`alibaba/qwen-audio-3-tts`](https://fal.ai/models/alibaba/qwen-audio-3-tts) | Alibaba | audio |
...
<details>
<summary><strong>vision</strong> — 34 models</summary>
...
| Isaac 0.1 [OpenAI Compatible Endpoint] | [`perceptron/isaac-01/openai/v1/chat/completions`](https://fal.ai/models/perceptron/isaac-01/openai/v1/chat/completions) | Perceptron | json |
...
<details>
<summary><strong>audio-to-video</strong> — 22 models</summary>
...
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/audio-to-video`](https://fal.ai/models/fal-ai/ltx-2.3-quality/audio-to-video) | LTX | video |
| Ltx 2.3 Quality | [`fal-ai/ltx-2.3-quality/audio-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2.3-quality/audio-to-video/lora) | LTX | video |
| LTX 2.3 Video Pro | [`fal-ai/ltx-2.3/audio-to-video`](https://fal.ai/models/fal-ai/ltx-2.3/audio-to-video) | LTX | video |
| Ltx 2.5 Audio to Video Fast | [`lightricks/ltx-2.5/audio-to-video/fast`](https://fal.ai/models/lightricks/ltx-2.5/audio-to-video/fast) | LTX | video |
| Ltx 2.5 Audio to Video Pro | [`lightricks/ltx-2.5/audio-to-video/pro`](https://fal.ai/models/lightricks/ltx-2.5/audio-to-video/pro) | LTX | video |
| LTX-2 19B | [`fal-ai/ltx-2-19b/audio-to-video`](https://fal.ai/models/fal-ai/ltx-2-19b/audio-to-video) | LTX | video |
| LTX-2 19B | [`fal-ai/ltx-2-19b/audio-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2-19b/audio-to-video/lora) | LTX | video |
| LTX-2 19B Distilled | [`fal-ai/ltx-2-19b/distilled/audio-to-video`](https://fal.ai/models/fal-ai/ltx-2-19b/distilled/audio-to-video) | LTX | video |
| LTX-2 19B Distilled | [`fal-ai/ltx-2-19b/distilled/audio-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2-19b/distilled/audio-to-video/lora) | LTX | video |
| LTX-2.3 22B | [`fal-ai/ltx-2.3-22b/audio-to-video`](https://fal.ai/models/fal-ai/ltx-2.3-22b/audio-to-video) | LTX | video |
| LTX-2.3 22B | [`fal-ai/ltx-2.3-22b/audio-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2.3-22b/audio-to-video/lora) | LTX | video |
| LTX-2.3 22B Distilled | [`fal-ai/ltx-2.3-22b/distilled/audio-to-video`](https://fal.ai/models/fal-ai/ltx-2.3-22b/distilled/audio-to-video) | LTX | video |
| LTX-2.3 22B Distilled | [`fal-ai/ltx-2.3-22b/distilled/audio-to-video/lora`](https://fal.ai/models/fal-ai/ltx-2.3-22b/distilled/audio-to-video/lora) | LTX | video |
| PixVerse VibeMV | [`pixverse/music-video/vibemv`](https://fal.ai/models/pixverse/music-video/vibemv) | Pixverse | video |
...
<details>
<summary><strong>text-to-3d</strong> — 14 models</summary>
...
| Meshy 7.1 Text to 3D | [`meshy/v7.1/text-to-3d`](https://fal.ai/models/meshy/v7.1/text-to-3d) | Meshy | file |
...
| Tripo P2 Text to 3D | [`tripo3d/p2/text-to-3d`](https://fal.ai/models/tripo3d/p2/text-to-3d) | Tripo3D | file |
| V7 Text to 3D | [`meshy/v7/text-to-3d`](https://fal.ai/models/meshy/v7/text-to-3d) | Meshy | file |

</details>

<details>
<summary><strong>3d-to-3d</strong> — 12 models</summary>

| Model | Endpoint | Lab | Output |
| --- | --- | --- | --- |
| Hi3D 3D Part Splitter | [`hitem3d/hi3d/split`](https://fal.ai/models/hitem3d/hi3d/split) | Hitem3D | file |
| Hi3D 3D to Multicolor | [`hitem3d/hi3d/multicolor`](https://fal.ai/models/hitem3d/hi3d/multicolor) | Hitem3D | file |
| Hi3D Texture | [`hitem3d/hi3d/texture`](https://fal.ai/models/hitem3d/hi3d/texture) | Hitem3D | file |
...
| Tripo3D Remesh | [`tripo3d/tripo/remesh`](https://fal.ai/models/tripo3d/tripo/remesh) | Tripo3D | file |
| Tripo3D Segment | [`tripo3d/tripo/segment`](https://fal.ai/models/tripo3d/tripo/segment) | Tripo3D | file |

</details>

<details>
<summary><strong>speech-to-text</strong> — 11 models</summary>

| Model | Endpoint | Lab | Output |
| --- | --- | --- | --- |
| Cohere Transcribe | [`fal-ai/cohere-transcribe`](https://fal.ai/models/fal-ai/cohere-transcribe) | Cohere | json |
| Elevenlabs - Forced Alignment | [`fal-ai/elevenlabs/forced-alignment`](https://fal.ai/models/fal-ai/elevenlabs/forced-alignment) | ElevenLabs | json |
...
<details>
<summary><strong>llm</strong> — 8 models</summary>
...
| OpenRouter Chat Completions [OpenAI Compatible] | [`openrouter/router/openai/v1/chat/completions`](https://fal.ai/models/openrouter/router/openai/v1/chat/completions) | Openrouter | json |
| OpenRouter Embeddings [OpenAI Compatible] | [`openrouter/router/openai/v1/embeddings`](https://fal.ai/models/openrouter/router/openai/v1/embeddings) | Openrouter | json |
| OpenRouter Responses [OpenAI Compatible] | [`openrouter/router/openai/v1/responses`](https://fal.ai/models/openrouter/router/openai/v1/responses) | Openrouter | json |
...
<details>
<summary><strong>video-to-audio</strong> — 6 models</summary>
...
| V1.1 Video to Sound Effects | [`sonilo/v1.1/video-to-sound-effects`](https://fal.ai/models/sonilo/v1.1/video-to-sound-effects) | Sonilo | audio |

</details>

<details>
<summary><strong>speech-to-speech</strong> — 4 models</summary>
...
| Grok Voice | [`xai/grok-voice`](https://fal.ai/models/xai/grok-voice) | xAI | audio |
| Grok Voice | [`xai/grok-voice/realtime`](https://fal.ai/models/xai/grok-voice/realtime) | xAI | json |

</details>

<details>
<summary><strong>image-to-json</strong> — 3 models</summary>

| Model | Endpoint | Lab | Output |
| --- | --- | --- | --- |
| Bagel | [`fal-ai/bagel/understand`](https://fal.ai/models/fal-ai/bagel/understand) | — | json |
| Bria Ad Delayer: Convert Flat Ads into Editable Layers \| fal | [`bria/ad-delayer`](https://fal.ai/models/bria/ad-delayer) | Bria AI | json |
| VGGT-1B | [`fal-ai/vggt-1b`](https://fal.ai/models/fal-ai/vggt-1b) | — | json |

</details>

<details>
<summary><strong>text-to-json</strong> — 3 models</summary>
...
<details>
<summary><strong>text-to-text</strong> — 1 model</summary>

| Model | Endpoint | Lab | Output |
| --- | --- | --- | --- |
| Router | [`openrouter/router/decisions`](https://fal.ai/models/openrouter/router/decisions) | Openrouter | json |
